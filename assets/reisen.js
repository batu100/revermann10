...
(function () {
  ...
  const header = `
    <header class="site-header"><div class="nav-shell">
      ...
      <nav class="nav-links" aria-label="Hauptnavigation">
        ...
        <div class="dropdown" id="ddReisen"><button type="button" aria-expanded="false" aria-haspopup="true" aria-controls="reisenMenu" style="background:var(--gold-50);color:var(--gold-dark);font-weight:600">Reisen <svg class="chev" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="m6 9 6 6 6-6"/></svg></button>
          <div class="dropdown-menu" id="reisenMenu"><a href="reisen.html">Aktuelle Reisen</a><a href="busreisen.html">Busreisen &amp; Tagesfahrten</a><a href="skireise-karlsbad.html">Skireise Karlsbad</a><a href="gruppenreisen.html">Gruppen- &amp; Vereinsreisen</a></div>
        </div>
  ...
  const footer = `
    <footer class="site-footer"><div class="container"><div class="footer-grid">
      ...
      <div><h5>Service</h5><ul><li><a href="reiseschutz.html">Reiseschutz</a></li><li><a href="kontakt.html">Kontakt &amp; Anfrage</a></li><li><a href="tel:+491723415004">Mobil: 0172 3415004</a></li><li><a href="tel:+4954313415">Festnetz: 05431 3415</a></li><li><a href="mailto:info@revermann.de">info@revermann.de</a></li></ul></div>
  ...
  function renderOverview(root) {
    ...
    root.innerHTML = `<section class="page-hero"><div class="container"><div class="reveal"><p class="crumbs"><a href="index.html">Start</a> › Reisen</p><span class="eyebrow">Reiseangebot</span><h1 class="display">Aktuelle Reisen.</h1><p class="lead">Alle Reisen auf einen Blick. Für Angebote ohne veröffentlichten Termin erhalten Sie die aktuellen Daten direkt bei uns.</p></div><div class="page-hero-media reveal"><img src="assets/img/bus-hero-reisebus.jpg" alt="Moderner Reisebus unterwegs bei Sonnenuntergang"></div></div></section>
